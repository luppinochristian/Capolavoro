...
const GS_GameData = (() => {
    ...
    const FUN_FACTS = {
        ...
        de: [
            '💡 „Pellegrino" war der ursprüngliche Name von Cristiano Ronaldo.',
            '💡 Messi hat 8 Ballons d\'Or gewonnen, der absolute Rekord.',
            '💡 Ronaldo hat in allen 40 europäischen Ländern getroffen, in denen er spielte.',
            '💡 Fußball ist der beliebteste Sport der Welt mit 4 Milliarden Fans.',
            '💡 Die offizielle Lebensdauer eines FIFA-Balls beträgt 3.600 Schüsse.',
            '💡 Maradona hatte einen dominanten linken Fuß, traf aber auch mit rechts.',
            '💡 Die erste Fußball-WM fand 1930 in Uruguay statt.',
            '💡 Pelé ist der einzige Spieler, der 3 Weltmeisterschaften gewann.',
            '💡 Die durchschnittliche Geschwindigkeit eines Torschusses beträgt 112 km/h.',
            '💡 Ein typischer Mittelfeldspieler läuft etwa 12 km pro Spiel.',
            '💡 Mbappé ist nach Pelé der zweitjüngste WM-Torschütze.',
            '💡 Torhüter sehen sich im Schnitt 2,5 Torschüssen pro Spiel gegenüber.',
            '💡 Lederbälle wurden offiziell bis in die 1970er verwendet.',
            '💡 Buffon spielte 17 Saisons in der Serie A ohne eine einzige Rote Karte.',
            '💡 Ronaldinho wurde zwei Jahre in Folge zum Weltfußballer gewählt.',
            '💡 Der direkte Freistoß wurde 1924 eingeführt.',
            '💡 Adidas patentierte 1954 die Fußballstollen.',
            '💡 Haaland erzielte 52 Tore in seiner ersten Premier-League-Saison.',
            '💡 Island ist die kleinste Nation, die je an einer WM teilnahm.',
            '💡 Das Manchester-Derby ist das meistgesehene Fußballspiel der Welt.',
        ],
        es: [
            '💡 «Pellegrino» era el nombre original de Cristiano Ronaldo.',
            '💡 Messi ha ganado 8 Balones de Oro, el récord absoluto.',
            ...
            '💡 La vida útil oficial de un balón FIFA es de 3.600 patadas.',
            '💡 Maradona tenía el pie izquierdo dominante, pero también marcaba con el derecho.',
            '💡 El primer Mundial de fútbol se celebró en Uruguay en 1930.',
            '💡 Pelé es el único jugador que ha ganado 3 Mundiales.',
            '💡 La velocidad media de un disparo a puerta es de 112 km/h.',
            '💡 Un centrocampista típico recorre unos 12 km por partido.',
            '💡 Mbappé es el segundo goleador más joven en un Mundial tras Pelé.',
            '💡 Los porteros enfrentan una media de 2,5 disparos a puerta por partido.',
            '💡 Los balones de cuero se usaron oficialmente hasta los años 70.',
            '💡 Buffon jugó 17 temporadas en la Serie A sin una sola tarjeta roja.',
            '💡 Ronaldinho fue elegido mejor jugador del mundo dos años consecutivos.',
            '💡 El tiro libre directo se introdujo en 1924.',
            '💡 Adidas patentó los tacos de fútbol en 1954.',
            '💡 Haaland marcó 52 goles en su primera temporada en la Premier League.',
            '💡 Islandia es la nación más pequeña que ha participado en un Mundial.',
            '💡 El derbi de Manchester es el partido más visto del mundo.',
        ],
    };
    ...
    return {
        ...
        // Expose data containers so the extended-data blocks below can merge into them.
        // (These are the same object references read by the getters above.)
        FUN_FACTS,
        QUOTES,
        PREMATCH_HYPE,
    };
...
// Merge with existing (FUN_FACTS lives inside the GS_GameData module — reference it via the export)
GS_GameData.FUN_FACTS.it = [...GS_GameData.FUN_FACTS.it, ...(EXTENDED_FUN_FACTS.it || [])];
GS_GameData.FUN_FACTS.en = [...GS_GameData.FUN_FACTS.en, ...(EXTENDED_FUN_FACTS.en || [])];
EXTENDED_FUN_FACTS.de = EXTENDED_FUN_FACTS.de || [];
EXTENDED_FUN_FACTS.es = EXTENDED_FUN_FACTS.es || [];
GS_GameData.FUN_FACTS.de = [...(GS_GameData.FUN_FACTS.de || [
...
GS_GameData.FUN_FACTS.es = [...(GS_GameData.FUN_FACTS.es || [
...
GS_GameData.PREMATCH_HYPE.it = [...GS_GameData.PREMATCH_HYPE.it, ...(EXTENDED_PREMATCH.it || [])];
GS_GameData.PREMATCH_HYPE.en = [...GS_GameData.PREMATCH_HYPE.en, ...(EXTENDED_PREMATCH.en || [])];
